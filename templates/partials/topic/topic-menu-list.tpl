...
<li>
	<a component="" href="#" class="dropdown-item rounded-1 d-flex align-items-center gap-2" role="menuitem"><i class="fa fa-fw fa-check text-secondary"></i>Endorse Topic</a>
</li>
